...
print("=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-")
print("Welcome to MKM ShoppingWeb!!!")
        ...
        while True:
                ...
                if selectednumber == "1": #sintaksis sehvi  var duzeld
                    ...
                    for item in items:
                        if item["id"] == choosenId:
                                if action == "B":
                                    ...
                                    f.write(f"[{time.strftime('%Y-%m-%d %H:%M:%S')}] Basket_add - {item['name']} - {item['price']}")
                                    f.close
                                    ...
                                    break
                                     ...
                                     f = open(history_file, "a", encoding="utf-8")
                                     f.write(f"[{time.strftime('%Y-%m-%d %H:%M:%S')}] Favorite_add - {item['name']} - {item['price']}")
                                     f.close()
                    ...
                    if testpassword == userpassword:
                        ...
                        if newpassword != userpassword and len(newpassword) >= 4:
                            ...
                            if newpassword == newpassword2:
                                ...
                                f = open(history_file, "a", encoding="utf-8")
                                f.write(f"[{time.strftime('%Y-%m-%d %H:%M:%S')}] Password_change")
                                f.close()
                    ...
                    if deletingelementnumber == "1":
                        ...
                        f = open(history_file, "a", encoding="utf-8")
                        f.write(f"[{time.strftime('%Y-%m-%d %H:%M:%S')}] Basket_remove - {removed_name}")
                        f.close()
                        ...
                        if not found:
                            ...
                            f = open(history_file, "a", encoding="utf-8")
                            f.write(f"[{time.strftime('%Y-%m-%d %H:%M:%S')}] Favorite_remove - {removed_name}")
                            f.close()
